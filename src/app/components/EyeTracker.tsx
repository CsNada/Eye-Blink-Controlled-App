...
export default function EyeTracker({ onEyeData }: EyeTrackerProps) {
  ...
  return (
    <div className="pointer-events-none fixed bottom-32 right-4 z-50 w-[260px] select-none sm:w-[300px]">
      <div className="overflow-hidden rounded-2xl border border-white/15 bg-slate-950/35 shadow-2xl backdrop-blur-xl">
