...
export function NotesPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 pb-5 animate-in fade-in duration-500">
      <h2 className="text-3xl font-bold mb-6">{t("notesTitle")}</h2>

      <div className="space-y-6">

        <Card className="border border-border shadow-lg grid gap-5 grid-cols-1 md:grid-cols-2 p-3">
          <div className="w-full">
            ...
            <FocusableButton
              ...
              variant="outline"
              className="min-h-[56px] w-full my-2 mb-3"
            >
          ...
          <div className="w-full">
            {showKeyboard ? (
              ...
              <Card className="border border-dashed bg-muted/30 mt-20">
